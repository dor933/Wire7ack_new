    ...
    return ((0, jsx_runtime_1.jsxs)(material_1.Grid, { container: true, style: {
            ...
            alignItems: "flex-end",
                    ...
                    flexDirection: "row",
                            ...
                            justifyContent: "flex-end",
                        }, children: [(0, jsx_runtime_1.jsxs)(material_1.Grid, { container: true, item: true, xs: 4, xl: 2, style: {
                                    display: "flex",
                                    padding: "10px 15px",
                                    alignItems: "center",
                                    borderRadius: "10px",
                                    background: "rgba(64, 75, 137, 0.10)",
                                        ...
                                        }, children: "Add Filter" })] }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 4, children: (0, jsx_runtime_1.jsx)(SearchBar_1.default, { SearchType: "Search", Fields: ChosenFields }) })] })] }), (0, jsx_runtime_1.jsxs)(material_1.Grid, { container: true, item: true, xs: 12, style: {
                    display: "flex",
                    justifyContent: "space-between",
                    alignItems: "center",
                    alignSelf: "stretch",
                    flexDirection: "row",
                            ...
                            gap: "10px",
                                ...
                                newrows.map((row) => row.Packets.map((packet) => packet.flags)).flat().filter((value, index, self) => self.indexOf(value) === index), ElementName: "Flags", Icon: (0, jsx_runtime_1.jsx)(KeyboardArrowDown_1.default, { style: {
                                        ...
                                        fontSize: "23px",
                                        marginTop: "5px",
                                    } }) })] }), (0, jsx_runtime_1.jsxs)(material_1.Grid, { container: true, item: true, xs: 4, style: {
                            flexDirection: "row",
                            display: "flex",
                            justifyContent: "space-between",
                                    ...
                                    width: "70%", // Ensure the Box spans the full width of the container
                                            ...
                                            marginBottom: "8px", // Adds space between rows
                                        }, children: [(0, jsx_runtime_1.jsx)("span", { style: { fontWeight: "600", minWidth: "140px", flexGrow: 1 }, children: "Source IP" }), (0, jsx_runtime_1.jsx)(material_2.Checkbox, { defaultChecked: false, color: "primary", id: "source.ip", onChange: (e) => {
                                                    if (e.target.checked) {
                                                ...
                                                }, inputProps: { "aria-label": "secondary checkbox" } }), (0, jsx_runtime_1.jsx)("span", { style: { fontWeight: "600", minWidth: "140px", flexGrow: 1 }, children: "Destination IP" }), (0, jsx_runtime_1.jsx)(material_2.Checkbox, { defaultChecked: false, color: "primary", id: "dest.ip", onChange: (e) => {
                                                    if (e.target.checked) {
                                            ...
                                            alignItems: "center",
                                            marginBottom: "8px", // Adds space between rows
                                        }, children: [(0, jsx_runtime_1.jsx)("span", { style: { fontWeight: "600", minWidth: "140px", flexGrow: 1 }, children: "Validity" }), (0, jsx_runtime_1.jsx)(material_2.Checkbox, { defaultChecked: false, color: "primary", id: "validity", onChange: (e) => {
                                                    if (e.target.checked) {
                                                ...
                                                }, inputProps: { "aria-label": "secondary checkbox" } }), (0, jsx_runtime_1.jsx)("span", { style: { fontWeight: "600", minWidth: "140px", flexGrow: 1 }, children: "Protocol" }), (0, jsx_runtime_1.jsx)(material_2.Checkbox, { defaultChecked: false, id: "protocol", onChange: (e) => {
                                                    if (e.target.checked) {
                                                ...
                                                }, color: "primary", inputProps: { "aria-label": "secondary checkbox" } })] })] }), (0, jsx_runtime_1.jsx)(material_1.Box, { style: {
                                    color: "#304C57",
                                    fontFamily: "Roboto",
                                    fontSize: "16px",
                                    fontWeight: "400",
