...
const Header = () => {
    ...
    const [Interfaces, setInterfaces] = (0, react_1.useState)(['Ethernet', 'Wi-Fi', 'Bluetooth', 'USB', 'NFC', 'Cellular', 'VPN', 'Other']);
    ...
    (0, react_1.useEffect)(() => {
        ...
        axios_1.default.get('http://localhost:8000/api/preconfig/interfaces').then((response) => {
            const extractedNames = response.data.map((device) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(material_1.Grid, { container: true, style: { display: "flex",
                    width: "100%",
                    padding: "10px 30px",
                                    ...
                                    justifyContent: "center",
                                            ...
                                            borderRadius: "10px",
                                                    ...
                                                    height: "24px",
                                                        ...
                                                        fontSize: "24px",
                                                    } }) })] })] })] })] }), (0, jsx_runtime_1.jsxs)(material_1.Grid, { container: true, style: { display: "flex",
                    width: "100%",
                    padding: "25px 30px",
                    justifyContent: "space-between",
                    alignItems: "center",
                    marginTop: '-30px',
                    marginLeft: "10px",
                }, children: [(0, jsx_runtime_1.jsx)(Top_Table_Element_1.default, { Data: Interfaces.map((interfaceName) => {
                            return interfaceName;
                        }), ElementName: "Interfaces", Icon: (0, jsx_runtime_1.jsx)(KeyboardArrowDown_1.default, { style: {
                                color: "#326591",
                                fontSize: "23px",
                                marginTop: "5px",
                            } }), SetNewValue: setChosenInterface }), (0, jsx_runtime_1.jsx)(material_1.Grid, { container: true, item: true, xs: 6, style: { display: "flex", alignItems: "center",
                            justifyContent: 'center'
                                ...
                                gap: '3px'
                                    ...
                                    }, children: "Status:" }), (0, jsx_runtime_1.jsx)("span", { style: {
                                        color: "var(--text-icon-primary-white, #FFF)",
                                        fontFamily: "Roboto",
                                        fontSize: "14px",
                                        fontStyle: "normal",
                                        ...
                                        letterSpacing: '0.1px',
                                        textTransform: 'capitalize'
                                    }, children: isConnectionopen ? "Connected" : "Disconnected" })] }) })] })] }));
};
