...
<path d="M16 15C13.79 16.333 10.208 16.333 8 15" stroke="#304C57" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    justifyContent: "space-between",
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<g opacity="0.8">
<path d="M3 17L12 22L21 17V14L12 19L3 14V11L12 16L21 11V8L12 13L3 8L12 3L17.418 6.01" stroke="#304C57" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</g>
</svg>
                        </Grid>
                        <Grid item xs={10} style={{
